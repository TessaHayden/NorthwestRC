        ...
        <div className="app__aboutus-content flex__center">
          <div className="app__aboutus-content-about">
            ...
            <p className="p__opensans">
              For many, the dream of owning their own resaurant runs very deep.
              A unique concept, an ideal location, the perfected menu item or a
              sense of community calls to the heart and gives you passion.
              Sometimes though, certain details may be beyond the general scope
              of knowledge. Everything from blueprints, equipment, full menu
